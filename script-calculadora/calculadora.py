...
class Calculadora(QMainWindow):
    def __init__(self, parent = None):
        ...
        self.setWindowTitle('Calculadora - Dayan')
        ...
        self.add_btn(
            ...
            'background-color: #d5580d; color: #FFF; font-weight: 700; font-size: 20px;'
            )
        ...
        self.add_btn(
            ...
            'background-color: #095177; color: #FFF; font-weight: 700; font-size: 20px;'
        )
        ...
        self.add_btn(
            QPushButton('='), 4, 4, 1, 1,
            self.eval_igual,
            'background-color: #13823a; color: #FFF; font-weight: 700; font-size: 20px;'
            )
